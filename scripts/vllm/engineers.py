...
ENGINEERS: tuple[Engineer, ...] = (
    ...
    Engineer("aarushjain29", "Aarushi Jain"),
    Engineer("charlifu", "Charlie Fu"),
    Engineer("djramic", "Djordje Ramic"),
    ...
    Engineer("music-dino", "Dino Music"),
    Engineer("peizhang56", "Pei Zhang"),
    Engineer("qli88", "Qiang Li"),
    Engineer("rasmith", "Randall Smith"),
    Engineer("ryanrock-amd", "Ryan Rock"),
    Engineer("stefankoncarevic", "Stefan Koncarevic"),
