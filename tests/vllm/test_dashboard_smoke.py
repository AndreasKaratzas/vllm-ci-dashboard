...
class TestIndexHtml:
    ...
    def test_queue_lifecycle_renderer_has_a_cache_busted_release(self):
        html = (DOCS / "index.html").read_text()
        assert 'assets/css/ops-v2.css?v=13' in html
        assert 'assets/js/ops-v2.js?v=25' in html
        assert 'assets/js/utils.js?v=60' in html
        assert 'assets/js/dashboard-nav.js?v=2' in html
